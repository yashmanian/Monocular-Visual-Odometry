...
\begin{DoxyCompactList}\small\item\em Computes epipole based on the idea that the epipoles lie on the epipolar plane. So Linear Least Squares to solve e2\+T$\ast$\+F$\ast$e1 = 0. \end{DoxyCompactList}\item 
void \hyperlink{classepipolar_a432430b23bb8a15d2ad9d9269b516839}{draw\+Epipolar\+Lines} (cv\+::\+Mat \&img1, cv\+::\+Mat \&img2, std\+::vector$<$ cv\+::\+Point2f $>$ \&points1, std\+::vector$<$ cv\+::\+Point2f $>$ \&points2, cv\+::\+Point2f \&epipole)
\begin{DoxyCompactList}\small\item\em Draws epipolar lines on the images passed in. Takes in the matched points and the two images. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Takes in the Fundamental matrix and returns a 3x2 matrix in homogenous form, with the coordinates for the epipole. \index{epipolar@{epipolar}!draw\+Epipolar\+Lines@{draw\+Epipolar\+Lines}}
\index{draw\+Epipolar\+Lines@{draw\+Epipolar\+Lines}!epipolar@{epipolar}}
\subsubsection[{\texorpdfstring{draw\+Epipolar\+Lines(cv\+::\+Mat \&img1, cv\+::\+Mat \&img2, std\+::vector$<$ cv\+::\+Point2f $>$ \&points1, std\+::vector$<$ cv\+::\+Point2f $>$ \&points2, cv\+::\+Point2f \&epipole)}{drawEpipolarLines(cv::Mat &img1, cv::Mat &img2, std::vector< cv::Point2f > &points1, std::vector< cv::Point2f > &points2, cv::Point2f &epipole)}}]{\setlength{\rightskip}{0pt plus 5cm}void epipolar\+::draw\+Epipolar\+Lines (
\begin{DoxyParamCaption}
\item[{cv\+::\+Mat \&}]{img1, }
\item[{cv\+::\+Mat \&}]{img2, }
\item[{std\+::vector$<$ cv\+::\+Point2f $>$ \&}]{points1, }
\item[{std\+::vector$<$ cv\+::\+Point2f $>$ \&}]{points2, }
\item[{cv\+::\+Point2f \&}]{epipole}
\end{DoxyParamCaption}
)}\hypertarget{classepipolar_a432430b23bb8a15d2ad9d9269b516839}{}\label{classepipolar_a432430b23bb8a15d2ad9d9269b516839}


Draws epipolar lines on the images passed in. Takes in the matched points and the two images. 

Draws the lines between the epipole and the features. \index{epipolar@{epipolar}!estimate\+Fundamental\+Matrix@{estimate\+Fundamental\+Matrix}}
...
Uses x2\+T$\ast$\+F$\ast$x1 = 0 as a distance function for the R\+A\+N\+S\+AC. Once inliers are selected, a final fundamental matrix is computed using them. \index{epipolar@{epipolar}!get\+Absolute\+Scale@{get\+Absolute\+Scale}}
